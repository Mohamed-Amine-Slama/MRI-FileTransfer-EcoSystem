...
> questions open. The blockers are legal, not code.
...
Holds ~1.8s. Beneath it, small: the MIR reticle mark and the wordmark, and in
...
**Scene durations:** 4.2 + 2.5 + 6.0 + 4.0 + 4.5 + 2.5 = **23.7s** ✓ (within 15–25)
...
## Factual guardrails (checked against the repo, 2026-09-20)

Every claim on screen is verified. Do not add any that are not:

- `verified 29 · blocked 9 · of 47` and `NOT LAUNCHABLE` — exact output of
